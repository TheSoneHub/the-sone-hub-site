...
export function TerminalGame() {
  ...
  return (
    <Card className="p-6 bg-card border-border animate-float">
      <div className="space-y-4">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-semibold text-card-foreground">Terminal Snake</h3>
        ...
        {!isPlaying && !gameOver && (
          <div className="text-center text-sm text-muted-foreground">
            <p>Classic Snake game in terminal style</p>
            <p className="mt-1">Eat the red dots, avoid the walls and yourself!</p>
          </div>
        )}
      </div>
    </Card>
